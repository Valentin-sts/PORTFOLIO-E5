      ...
      projects: [
        {
          ...
          description: "Déploiement d'un contrôleur de domaine sous Windows Server 2022 pour centraliser la gestion des utilisateurs, postes et droits d'accès.",
          items: [
        ...
        },
        {
          ...
          description: "Déploiement d'un serveur SAMBA sous Debian pour centraliser les partages réseau et gérer les droits d'accès par utilisateur et par groupe.",
          items: [
            ...
            "Définition des droits d'accès par partage (valid users, permissions NTFS)",
            "Tests d'accès depuis un poste client Windows et supervision via smbstatus"
          ],
        ...
        },
        {
          ...
          description: "Intégration de machines Linux (Ubuntu/Debian) au domaine Active Directory via SSSD / realmd / Kerberos 5 pour centraliser l'authentification.",
          items: [
        ...
        },
        {
          ...
          description: "Mise en place d'une architecture redondante sur les switchs de cœur avec basculement automatique de passerelle (HSRP) et convergence rapide (Rapid-PVST).",
          items: [
            "Configuration du trunk 802.1Q inter-cœur et des VLANs sur SW3 et SW4",
            "Rapid-PVST : SW3 root bridge primaire (4096), SW4 secondaire (8192)",
            "HSRP : SW3 actif (priorité 110), SW4 standby (100), IP virtuelle .254 partagée",
